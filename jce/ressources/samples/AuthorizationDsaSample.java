 ...
 */
public class AuthorizationDsaSample {
	...
	public static void main(final String... args) throws Exception {
		...
		final KeyPair integrityKeyPair = (KeyPair)PrimusName.generate(
			KeyPairGenerator.getInstance("DSA", PrimusProvider.getProviderName()),
			keySize,
			integrityKeyName,
		...
		final KeyPairGenerator localKeyPairGenerator = KeyPairGenerator.getInstance("DSA");
