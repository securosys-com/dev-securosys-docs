 ...
 * using a wrapped key in an atomic unwrap/sign way.
 */
public class RsaSampleWrapAtomic {
	...
	public static void main(final String... args) throws Exception {
		...
		final byte[] sig = PrimusWrap.aesUnwrapPadRsaSign("SHA256withRSA", message, (SecretKey)keyStore.getKey(aeskeyname, null), wrapped);
