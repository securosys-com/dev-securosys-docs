 ...
 */
public class AuthorizationCertificatesSample {
	...
	public static void main(final String... args) throws Exception {
		...
		final ECGenParameterSpec curve = new ECGenParameterSpec("secp256r1"); // secp256k1 is not well supported by Sun/Oracle fro Java version 17 on
		final String signAlgorithm = "SHA256withECDSA";
		// final String keccakSignAlgorithm = "KECCAK256withECDSA";
		...
		final Certificate[] operationCertificates = new Certificate[] {acert, bcert,};
		...
		final byte[][] asignature = new byte[1][];
		final String xml = PrimusAttestation.getSignedAttributes(attestationKeyName, signKey, asignature);
		System.out.println();
