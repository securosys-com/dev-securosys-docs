...
public class ApprovalModifyCkdSample {
	...
	public static void main(final String... args) throws Exception {
		...
		// pseudo-derived-key
		final PrivateKey signKey = new PrimusSpecs.CkdDerivedPrivateKey(baseKey, derivationPath);
		...
		final byte[] payload2 = PrimusAccess.getModifyAccessPayload(baseKey, superAccess);

		// approval for modify operation
		final byte[] tokenChallenge2 = (new PrimusApprovalToken(PrimusApprovalToken.OPERATION_MODIFY, payload2, baseKeyName)).getEncoding();
		...
		// modify
		PrimusAccess.modifyAccess(baseKey, superAccess);
