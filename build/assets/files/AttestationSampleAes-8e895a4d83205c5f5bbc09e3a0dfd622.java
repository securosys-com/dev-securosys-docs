 ...
 */
public class AttestationSampleAes {
	...
	public static void main(final String... args) throws Exception {
		...
		final String keyname = "aes-key-" + UUID.randomUUID().toString();
		final Key key = (Key)PrimusName.generate(KeyGenerator.getInstance("AES", PrimusProvider.getProviderName()), 256, keyname);
