...
<primus version="2" minor="2" name="PRIMUS-HSM-MASTER" state="master" serialnumber="000000000">
	...
	<!-- Remote administration (Decanus) for device management configuration -->
	<decanus_process>
		<active>enabled</active>
		<port>2340</port>
	...
	<crypto_process>
		...
		<!-- initial setup password life in hours -->
		...
		<!-- attempt reset time interval, default 100 attempts in 300s -->
		<login_lockout_time>300</login_lockout_time>
		<!-- lock out time in s if attempts in interval are exceeded -->
